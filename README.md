...
| `E:go-waku`  | go-waku                 | MVP quality software, include all supported bindings (i.e. Rust)                   | Implement protocol in go-waku. May not always be relevant - need to conclude multiple client discussion. Otherwise, same as nwaku.                                                       |
